We are forking this project to measure the ground truth graphs and the graphs generated by the proposed methods with different clustering metrics. The purpose of such measurements is to study the realism of EPGMs and those generated through the proposed binding procedures. Our additional analysis is in the **cluster_analysis** directory.
